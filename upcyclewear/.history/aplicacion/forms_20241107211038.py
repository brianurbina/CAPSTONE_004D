...
class FundacionForm(forms.ModelForm):
    ...
    # Establecer valor por defecto para comuna_region (vacío)
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Establecer valor vacío como el valor por defecto para 'comuna_region'
        self.fields['comuna_region'].initial = ''  # Esto asegura que 'Selecciona una comuna' sea la opción predeterminada.
