...
def crear_fundacion(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'menuuser/fundaciones.html', {'form': form})  # nos redige ahora al forms para ver el mensaje Renderiza el formulario con el mensaje de éxito
