...
from .forms import UsuarioRegisterForm, FundacionForm, PeticionForm, DonacionForm, FundacionFormMod, ReseñaForm
from django.contrib.auth import authenticate, login, logout
from django.contrib import messages
from django.contrib.auth.models import User
from django.contrib.auth.decorators import login_required, user_passes_test
from django.http import JsonResponse
from .models import Usuario, Fundacion, Peticion, Donacion, Conversacion, Mensaje, Reseña
...
def perfil_usuario(request, username):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            nueva_reseña.id_resena = uuid.uuid4()  # Generar un UUID para id_reseña
    ...
    if query:
        foundations = Fundacion.objects.filter(
            ...
            Q(telefono__icontains=query)
              ...
              # Paginación
        paginator = Paginator(foundations, 10)  # 10 peticiones por página
        page_number = request.GET.get('page')
        page_obj = paginator.get_page(page_number)
    else:
