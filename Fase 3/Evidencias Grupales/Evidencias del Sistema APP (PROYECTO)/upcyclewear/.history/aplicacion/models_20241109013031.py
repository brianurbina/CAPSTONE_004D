...
class Notificacion(models.Model):
    respuesta_choices = [  ('SI', 'SI'),
        ('NO', 'NO'),
        ('PENDIENTE', 'PENDIENTE'),]
    respuesta_choices = [  ('PETICION', 'PETICION'),
        ('DONACION', 'DONACION'),]
    ...
    respuesta = models.TextField( choices=respuesta_choices, default='')
    idid = models.TextField()
    tipo= models.TextField(choices= respuesta_choices, default='')
