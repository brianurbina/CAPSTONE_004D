...
def obtener_mensajes_no_leidos(request):
    if request.user.is_authenticated:
        ...
        mensajes_detalles = mensajes_no_leidos.order_by('-fecha_hora')[:3].values('id_mensaje', 'mensaje', 'emisor__username', 'fecha_hora')
    ...
    # Si el usuario no está autenticado, devolver 0 mensajes no leídos
