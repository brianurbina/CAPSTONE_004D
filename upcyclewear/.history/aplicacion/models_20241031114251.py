...
class PeticionForm(models.Model):
    class Meta:
        model = Peticion
        ...
        widgets = {
            'id': models.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ingrese el ID', 'id': 'id'}),
            'titulo': models.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ingrese el título de la petición', 'id': 'titulo'}),
            'tipo_ropa': models.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ingrese el tipo de ropa', 'id': 'tipo_ropa'}),
            'descripcion': models.Textarea(attrs={'class': 'form-control', 'placeholder': 'Ingrese una descripción detallada', 'id': 'descripcion', 'rows': 3}),
            'estado': models.Select(choices=Peticion.ESTADO_CHOICES, attrs={'class': 'form-control', 'id': 'estado'}),
            'donador': models.Select(attrs={'class': 'form-control', 'id': 'donador'}),
        }
