...
def enviar_correo_reporte(request, reporte_id):
    if request.method == 'POST':
        ...
        # Crear el contexto para la plantilla HTML
        contexto = {
            'usuario_reportante': reporte.usuario_reportante.username,
            'usuario_reportado': reporte.usuario_reportado.username,
            'estado': estado,
            'motivo': motivo,
        }
        
        # Renderizar la plantilla HTML
        mensaje_html = render_to_string('emails/reporte_estado.html', contexto)
