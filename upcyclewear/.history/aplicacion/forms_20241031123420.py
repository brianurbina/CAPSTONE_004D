...
class DonacionForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            'id': 'ID',
            'usuario': 'Usuario',   # Etiqueta para el usuario
            'titulo': 'Título',
            'tipo_ropa': 'Tipo de Ropa',
            'talla': 'Talla',
            'temporada': 'Temporada',
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Personalizar el queryset de receptores, por ejemplo, para incluir solo usuarios activos
        self.fields['receptor'].queryset = Usuario.objects.filter(is_active=True)

        # Hacer que el campo ID sea de solo lectura
        self.fields['id'].widget.attrs['readonly'] = True


        self.fields['usuario'].queryset = Usuario.objects.all()  # Asegúrate de mostrar todos los usuarios disponibles
