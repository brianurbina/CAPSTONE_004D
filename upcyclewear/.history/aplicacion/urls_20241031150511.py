...
urlpatterns = [
    ...
    path('eliminar-fundacion/<int:id>/', views.eliminar_fundacion, name='eliminar_fundacion'),
    path('eliminar-donacion/<int:id>/', views.eliminar_donacion, name='eliminar_donacion'),
    path('eliminar-peticion/<int:id>/', views.eliminar_peticion, name='eliminar_peticion'),
]