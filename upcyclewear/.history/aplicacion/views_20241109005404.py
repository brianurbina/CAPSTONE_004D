...
def finalizar_donacion2(request, id):
    if request.method == 'POST':
        ...
        try:
            ...
            donacion.receptor = donador  # Ahora asignamos el donador como receptor de la donación
            ...
            Notificacion.objects.create(
                ...
                leida=False,
                respuesta="PENDIENTE",
                donacion=donacion  # Relacionamos la notificación con la donación
            )
