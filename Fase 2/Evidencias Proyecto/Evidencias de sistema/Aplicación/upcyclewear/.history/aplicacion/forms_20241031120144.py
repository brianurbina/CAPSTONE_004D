...
class PeticionFormMod(forms.ModelForm):
    class Meta:
        model = Peticion
        fields = ['titulo', 'tipo_ropa', 'descripcion', 'estado', 'donador']
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Llenar el campo 'donador' con los usuarios
        self.fields['donador'].queryset = Usuario.objects.all()
        self.fields['donador'].empty_label = "Selecciona un donador"
