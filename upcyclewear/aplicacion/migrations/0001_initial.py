    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logotipo', models.ImageField(blank=True, null=True, upload_to='fundaciones/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='donaciones_realizadas', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('revisado', 'Revisado'), ('resuelto', 'Resuelto')], max_length=20)),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
