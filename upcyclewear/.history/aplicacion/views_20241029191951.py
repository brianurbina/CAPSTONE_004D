...
from .forms import UsuarioRegisterForm, FundacionForm, PeticionForm, DonacionForm, FundacionFormMod, ReseñaForm, ReporteUsuarioForm
...
def perfil_usuario(request, username):
    ...
    # Captura el parámetro 'tab' de la URL
    active_tab = request.GET.get('tab', 'perfil')  # Por defecto, la pestaña de perfil está activa
    ...
    return render(request, 'perfil/perfil_usuario.html', {
        ...
        'active_tab': active_tab,  # Pasamos la pestaña activa al template
    })
