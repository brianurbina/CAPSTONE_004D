...
from .models import Usuario, Fundacion, Peticion, Donacion, Conversacion, Mensaje, Reseña, Reporte
...
def perfil_usuario(request, username):
    ...
    if request.method == 'POST' and 'enviar_reporte' in request.POST:
        if reporte_form.is_valid():
            ...
            nuevo_reporte.id_reporte = uuid.uuid4()  # Generar un UUID para el id_reporte
            nuevo_reporte.save()
            return redirect('perfil_usuario', username=username)  # Redirige para evitar reenvíos
