...
urlpatterns = [
    ...
    path('gestionar_reportes/', views.gestionar_reportes, name='gestionar_reportes'),
    path('actualizar_estado_reporte/<str:reporte_id>/<str:nuevo_estado>/', views.actualizar_estado_reporte, name='actualizar_estado_reporte'),
]