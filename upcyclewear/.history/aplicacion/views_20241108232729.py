...
def notificacion_detail(request, notificacion_id):
    # Obtener la notificación por su id o devolver 404 si no se encuentra
    notificacion = get_object_or_404(Notificacion, id=notificacion_id)
    peticion = Peticion.objects.get(id=notificacion.peticion.id)
    
    # Retornar el contexto a la plantilla con la notificación y la petición
    context = {'notificacion': notificacion, 'peticion': peticion}
    return render(request, 'details/notificacion.html', context)
