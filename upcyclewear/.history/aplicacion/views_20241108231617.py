...
def notificacion_detail(request, id):
    # Obtener la notificación por su id o devolver 404 si no se encuentra
    notificacion = get_object_or_404(Notificacion, id=id)
    
    # Retornar el contexto a la plantilla con la notificación
    return render(request, 'details/notificacion.html', {'notificacion': notificacion})