...
from .forms import UsuarioRegisterForm, FundacionForm, PeticionForm, DonacionForm, FundacionFormMod, ReseñaForm, ReporteUsuarioForm, PeticionFormMod
...
def modificar_peticion(request, id):
    ...
    return render(request, 'modificar/mod_peticion.html', {'form': form})
