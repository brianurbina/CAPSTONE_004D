...
def eliminar_fundacion(request, rut):
    fundacion = get_object_or_404(Fundacion, id=rut)
    ...
    return render(request, 'confirmar_eliminacion.html', {'objeto': fundacion, 'tipo': 'Fundación'})
...
def eliminar_donacion(request, id):
    ...
    return render(request, 'confirmar_eliminacion.html', {'objeto': donacion, 'tipo': 'Donación'})
...
def eliminar_peticion(request, id):
    ...
    return render(request, 'confirmar/confirmar_eliminacion.html', {'objeto': peticion, 'tipo': 'Petición'})
