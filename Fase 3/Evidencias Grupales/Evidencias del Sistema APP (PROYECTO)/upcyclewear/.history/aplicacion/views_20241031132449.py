...
def mi_perfil(request):
    user = request.user  # Asegúrate de obtener el usuario actual
    if request.method == 'POST':
        ...
        if request.FILES.get('foto_perfil'):
            ...
            # Si no hay archivo nuevo, manten la foto por defecto si se ha eliminado
            if 'remove_image' in request.POST:
                user.foto_perfil = 'img/nofoto.jpg'  # Cambia a la imagen por defecto
